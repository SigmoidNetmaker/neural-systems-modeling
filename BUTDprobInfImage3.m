...
% in this case the posteriors of combo 1 and feature 1
% given image 3 are computed
...
pf1gi3BayesU=pf1*...
    (pi3gc1*pc1gl1f1*pl1 + pi3gc2*pc2gl1f1*pl1+...
    pi3gc3*pc3gl1f1*pl1 + pi3gc4*pc4gl1f1*pl1+...
    pi3gc1*pc1gl2f1*pl2 + pi3gc2*pc2gl2f1*pl2+...
    pi3gc3*pc3gl2f1*pl2 + pi3gc4*pc4gl2f1*pl2);

% compute un-normalized posterior of feature 2 given image 1
pf2gi3BayesU=pf2*...
    (pi3gc1*pc1gl1f2*pl1 + pi3gc2*pc2gl1f2*pl1+...
    pi3gc3*pc3gl1f2*pl1 + pi3gc4*pc4gl1f2*pl1+...
    pi3gc1*pc1gl2f2*pl2 + pi3gc2*pc2gl2f2*pl2+...
    pi3gc3*pc3gl2f2*pl2 + pi3gc4*pc4gl2f2*pl2);

% compute normalized posterior of feature 1 given image 1
pf1gi3Bayes=pf1gi3BayesU/(pf1gi3BayesU+pf2gi3BayesU);
...
pc1gi3Bayes=pc1gi3BayesU/...
    (pc1gi3BayesU+pc2gi3BayesU+pc3gi3BayesU+pc4gi3BayesU);


[pc1gi3Bayes pf1gi3Bayes]
